import { faFolderPlus, faSignInAlt, faUserEdit, faUserPlus } from '@fortawesome/free-solid-svg-icons';
...
class UpdateUser extends Component {
    ...
    // API Call
    componentDidMount() {
        const userId = localStorage.getItem("updateUser");
        if (userId) {
                            ...
                            <MDBCard>
                                <MDBCardBody>
                                    <form onSubmit={this.addUser}>
                                        <p className="h4 text-center py-4">UPDATE USER DETAILS</p>
